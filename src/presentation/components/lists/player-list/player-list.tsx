  ...
  return (
    <section>
      ...
      {props.players.map((player) => (
        <li key={player.userName} className="flex items-center justify-start gap-4 hover:bg-gray-300 p-2 rounded-lg hover:text-gray-950 text-sm lg:text-lg text-gray-50">
